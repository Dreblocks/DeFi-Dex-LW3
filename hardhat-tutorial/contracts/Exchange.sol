...
contract Exchange is ERC20 {
    ...
    //It's address of the _CryptoDevToken that you deployed in the ICO tutorial
    ...
    //this function adds liquidity to the exchange
...
//The amount of ether or crypto Dev that would be sent back to the user would be based on a ratio
